    ...
    <style>
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .nav-item {
            ...
            padding: 11px 14px;
            font-size: 13.5px; font-weight: 500; color: #C6DBEF;
        ...
        .logout-btn {
            display: flex; align-items: center; gap: 10px;
            padding: 12px 14px; font-size: 14px; font-weight: 500; color: #9ECAE1;
        ...
        /* ── Resolved banner ── */
        .resolved-banner {
            background: var(--color-green-banner);
        ...
        .modal-overlay {
            ...
            background: rgba(8,81,156,0.45); z-index: 400;
            align-items: center; justify-content: center; padding: 16px;
        }
        .modal-overlay.show { display: flex; }
        .modal-box {
            background: var(--bg-surface); border-radius: 18px; padding: 28px;
        ...
        .modal-value {
            ...
            background: var(--bg-input); border-radius: 9px; padding: 10px 13px;
        }
    ...
    <div class="content">
        ...
        <div class="stats-strip">
            <div class="stat-pill">
                ...
                <div>
                    <div class="stat-num">{{ $complaints->total() }}</div>
                    <div class="stat-lbl">Total Resolved</div>
                </div>
            </div>
            <div class="stat-pill">
                ...
                <div>
                    ...
                    <div class="stat-lbl">Resolved This Week</div>
                </div>
            </div>
            <div class="stat-pill">
...
<script>
    ...
    document.addEventListener('click', function(e) {
        ...
        if (btn) {
            ...
            if (!d) return;
            document.getElementById('dm-citizen').textContent  = d.citizen;
